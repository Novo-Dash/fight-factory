...
export function BackToSchoolNavbar() {
  ...
  return (
    ...
    >
      <div className="max-w-[1440px] mx-auto px-4 md:px-8 flex items-center justify-between" style={{ gap: '2rem' }}>
        ...
        <a href="#top" onClick={e => { e.preventDefault(); window.scrollTo({ top: 0, behavior: 'smooth' }) }} aria-label="Fight Factory Jiu-Jitsu Back to School" className="flex items-center shrink-0" style={{ lineHeight: 0 }}>
          <img
